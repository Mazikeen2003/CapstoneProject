...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <x-stat-card title="Total Projects" value="0" iconColor="#1e40af" />
        <x-stat-card title="Ongoing Projects" value="0" iconColor="#fbbf24" />
        <x-stat-card title="Completed Projects" value="0" iconColor="#10b981" />
        <x-stat-card title="Budget Allocated" value="₱0" iconColor="#f43f5e" />
    </div>
