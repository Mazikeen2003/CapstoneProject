...
<div class="space-y-6">
    <div>
        <h1 class="text-3xl font-bold">Public Project Analytics</h1>
        <p class="text-sm text-slate-500">All public project data shown with the same layout used by barangay analytics.</p>
    </div>
        ...
        <div class="bg-white rounded-lg p-6" style="border: 1px solid #B2BEB5;">
            ...
            <div class="space-y-3">
                ...
                <div class="border-t border-gray-200 pt-3 flex justify-between">
                    ...
                    <span class="font-bold" style="color: #10b981;">₱{{ number_format(max($stats['total_budget'] - $stats['total_spent'], 0), 2) }}</span>
                </div>
            </div>
        </div>
    ...
    @if($stats['total_projects'] === 0)
        <div class="bg-blue-50 border border-blue-300 rounded-lg p-4 text-sm text-blue-700">
            No public projects have been recorded yet.
        </div>
    @endif
</div>
@endsection
