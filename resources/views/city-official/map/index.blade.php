                ...
                fetch('{{ route('api.projects.geojson') }}')
                    ...
                    .then(function(projectData) {
                        ...
                        projectData.features.forEach(function(project, index) {
                            ...
                            marker.bindPopup(`<div class="text-sm" style="color: ${document.documentElement.classList.contains('dark') ? '#f1f5f9' : '#000'}"><strong style="color: ${document.documentElement.classList.contains('dark') ? '#f1f5f9' : '#000'}">${project.properties.name}</strong><br><span class="text-xs" style="color: ${document.documentElement.classList.contains('dark') ? '#cbd5e1' : '#4b5563'}">${project.properties.status || 'Unknown'}</span></div>`);
