...
#map .leaflet-tile-pane.city-map-dark-tiles { filter: brightness(.26) saturate(.5) contrast(1.4) hue-rotate(165deg); }
        ...
        fetch('{{ asset('data/cabuyao-map.geojson') }}')
            ...
            .then(function(geojson) {
                ...
                document.getElementById('btnLightTiles').addEventListener('click', function() {
                    ...
                    map.getPane('tilePane').classList.remove('city-map-dark-tiles');
                ...
                document.getElementById('btnDarkTiles').addEventListener('click', function() {
                    ...
                    map.getPane('tilePane').classList.add('city-map-dark-tiles');
