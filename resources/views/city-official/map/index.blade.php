...
<div class="flex flex-col md:flex-row gap-0 h-[calc(100svh-80px)] min-h-[65svh] min-w-0 overflow-hidden rounded-lg border border-gray-300 shadow-sm">
    <div class="flex-1 min-w-0 w-full relative h-full" id="map" style="background-color: #f0f0f0;"></div>
    ...
    <div id="projectSidebar" class="fixed inset-0 z-[10000] w-full bg-white border-t md:relative md:inset-auto md:w-[360px] md:border-t-0 md:border-l border-gray-200 overflow-y-auto max-h-[100svh] shadow-sm order-3 md:order-2 md:max-h-full hidden md:block" role="dialog" aria-label="City project list">
