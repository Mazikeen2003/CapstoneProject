...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="rounded-lg p-6 bg-white" style="border: 1px solid #B2BEB5;">
            <p class="text-xs text-gray-500 uppercase">Total Budget Allocated</p>
    ...
    <!-- Map Section -->
    <div class="rounded-lg p-6 bg-white" style="border: 1px solid #B2BEB5;">
        <h2 class="text-xl font-bold text-black mb-4">Citywide Project Map</h2>
        <div id="city-map" class="h-96 rounded-lg overflow-hidden" style="border: 1px solid #B2BEB5;"></div>
    </div>
                ...
                @foreach ($recentProjects as $project)
                    <div class="flex justify-between items-center pb-3 border-b border-gray-200">
                        <div>
                            ...
                            <p class="text-xs text-gray-500">{{ $project->current_status }} • {{ $project->barangay?->barangay_name ?? 'Citywide' }}</p>
                        </div>
