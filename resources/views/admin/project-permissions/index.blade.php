        ...
        @forelse ($requests as $request)
            <div class="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <span class="inline-flex rounded-full bg-slate-100 px-3 py-1 text-xs font-semibold text-slate-700">{{ ucfirst($request->status) }}</span>
                </div>
                ...
                <div class="mt-4 flex flex-wrap gap-2">
                    ...
                    @else
                        <span class="rounded-full bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-600">Reviewed</span>
                    @endif
                </div>
            </div>
        @empty
