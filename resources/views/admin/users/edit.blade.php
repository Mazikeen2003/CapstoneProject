    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        ...
        <form action="{{ route('admin.users.update', $user->user_id) }}" method="POST" class="space-y-6">
            ...
            <div id="departmentPermissionsSection" class="border border-gray-200 rounded-lg p-5 bg-gray-50" style="display: none;">
                ...
                <p class="text-xs text-gray-500 mb-4">Choose which actions this Planning user is allowed to perform. All are enabled by default (full access) unless unchecked.</p>
            ...
            <div class="flex gap-4 pt-4 border-t border-gray-200">
                <button type="submit" data-loading-text="Updating..." class="bg-blue-600 text-white px-6 py-2.5 rounded-lg hover:bg-blue-700 font-semibold transition inline-flex items-center justify-center gap-2">
                    <span class="loading-spinner hidden h-4 w-4 animate-spin rounded-full border-2 border-white border-t-transparent"></span>
                    <span class="loading-label">Update User</span>
                </button>
